...
==ВАЖНО!== Если вы хотите кратко и быстро прочитать документацию перейдите в раздел (здесь должна быть ссылка на доку для разрабов) (имейте в виду, термины и другие определения не будут объясняться так же, как и в этой документации. Если вы не уверены в своих силах и навыках, то сперва прочитайте эту документацию).
